        ...
        switch (payload->hit_obj->materialType) {
            case REFLECTION_AND_REFRACTION: {
                ...
                Vector3f reflectionColor =
                        castRay(reflectionRayOrig, reflectionDirection, scene,
                                depth + 1);
                Vector3f refractionColor =
                        castRay(refractionRayOrig, refractionDirection, scene,
                                depth + 1);
            ...
            default: {
                ...
                Vector3f shadowPointOrig =
                        (dotProduct(dir, N) < 0) ? hitPoint + N * scene.epsilon
                                                 : hitPoint - N * scene.epsilon;
                // [comment]
                ...
                for (auto &light : scene.get_lights()) {
                    ...
                    bool inShadow   = shadow_res &&
                                    (shadow_res->tNear * shadow_res->tNear <
                                     lightDistance2);
